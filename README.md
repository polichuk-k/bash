...
| ------------- | ------------- | ------------- |
| `c`  | a+b  | Так как присвоено выражение a+b |
| `d`  | 1+2  | Так ка переменные не обьявлены как целочисленные(declair) и нет скобок  |
| `e`  | 3  | Так как переменные, обьявлены как целочисленные значения, правильный синтаксис |
